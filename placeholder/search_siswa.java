 ...
 * @author Ibrar
 */
public class search_siswa extends JTextField {
    ...
    public search_siswa(String text) {
        initListener();
    }
    
    public search_siswa(int columns) {
        initListener();
    }
    
    public search_siswa(String text, int columns) {
        super(text, columns);
        initListener();
    }
    
    public search_siswa(Document doc, String text, int columns) {
