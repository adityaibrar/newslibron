...
public class search_buku extends JTextField {
    ...
    public search_buku(String text) {
        initListener();
    }
    
    public search_buku(int columns) {
        initListener();
    }
    
    public search_buku(String text, int columns) {
        super(text, columns);
        initListener();
    }
    
    public search_buku(Document doc, String text, int columns) {
